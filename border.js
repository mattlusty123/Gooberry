...
// WARNING due to the currect workaround to fully format horizontal lines - copyPastFormat 
// it the borders on FirstLine and Lastline will be copied from the top of two inserted rows beneath
// these inserted rows should continue on side borders etc from row above
